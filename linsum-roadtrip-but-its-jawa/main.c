/*modifikasi algoritma djikstra Reynaldo A. untuk peta perjalanan
antar kota.*/
...
int main (){
    ...
    // Input file kota
    printf("Selamat datang di database peta perjalanan.\n");
    printf("Silahkan masukkan nama file database nama kota di peta: ");
    ...
    printf("Pembacaan nama kota di peta berhasil.\n");
    ...
    while(progress=='y'){
        ...
        printf("\nBerikut adalah daftar kota dalam peta.\n");
        ...
        printf("\nJarak antara kedua kota tersebut adalah %d m\n\n",jarak_final[idx_tujuan]);

        printf("Apakah anda masih ingin menggunakan peta? [y/n]: ");
        scanf(" %c",&progress);
    }
}
